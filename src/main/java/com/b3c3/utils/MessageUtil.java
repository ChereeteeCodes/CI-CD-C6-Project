...
public class MessageUtil {
    ...
    public static void main(String[] args) {
        ...
        // java -cp /tmp/messageUtil-1.0.jar com.b3c3.utils.MessageUtil

        System.out.println("-------Running the main method in Message Utility-------\n");
        ...
        System.out.println(
                "Hey my name is Charity Francis. I have mastered CodeCommit, CodeBuild, and CodeDeploy. What ya think about that? You are impressed! Or not?");
    }
}